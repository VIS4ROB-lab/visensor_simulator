...
def main():    
    ...
    parser.add_argument('-ext','--only_extremes', dest='only_extremes', action='store_true',default=False,  help='create only the turning poitns')
...
#todo Add validation to the input    
    ...
    if parsed.only_extremes:
        horizontal_positions = [0,parsed.ground_lenght_horizontal]
    else:
