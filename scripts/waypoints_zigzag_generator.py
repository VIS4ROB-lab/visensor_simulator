...
def main():    
    ...
    parser.add_argument('-bbn','--bound_box_north',  metavar='value', type=float,default=15,  help='max lenght of the trajectory in the north direction (in meters)')
    parser.add_argument('-bbe','--bound_box_east',  metavar='value', type=float,default=6,  help='max lenght of the trajectory in the east direction (in meters)')
    ...
    parser.add_argument('-sn','--step_north',  metavar='value', type=float,default=1,  help='step size in the north direction (in meters)')
    parser.add_argument('-se','--step_east',  metavar='value', type=float,default=1,  help='step size in the east direction (in meters)')
    parser.add_argument('-su','--step_up',  metavar='value', type=float,default=0, help='step size in the up direction (in meters)')
    
    parser.add_argument('-on','--offset_north',  metavar='value', type=float,default=1, help='offset on north direction (in meters)')
    parser.add_argument('-oe','--offset_east',  metavar='value', type=float,default=3, help='offset on east direction (in meters)')
    parser.add_argument('-ou','--offset_up',  metavar='value', type=float,default=1, help='offset on up direction (in meters). Simulators usually cannot work with up= 0')
    parser.add_argument('-he','--heading',  metavar='value', type=float,default=180, help='desired constant heading-yaw (degrees)')
    ...
    with open(parsed.output,'w') as output_file:
        for row in range(num_rows):
            ...
            for col in range(num_rows_east):
                ...
                output_file.write('{0:.2f},{1:.2f},{2:.2f},{3:.2f}\n'.format( n,-e_directional+parsed.offset_east,u,parsed.heading))
